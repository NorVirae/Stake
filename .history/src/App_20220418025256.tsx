    ...
    <div className="stake-container">
      <header>
        <nav>
            ...
            <ul>
              {isWalletConnected?}              <li className='connect-wallet-btn'>Connect Wallet</li>
              <li className='connect-wallet-btn'>0.00 BNB <li className='connect-wallet-btn'>0xa3...dd0d</li></li>
