...
function App() {
  ...
  const checkIfStaked = () => {
    if (staked){
      return <UnStakeModal showModal={showModal} setShowModal={setShowModal} />
    }else{
      return StakeModal showModal={showModal} setShowModal={setShowModal} />
    }
  }
  ...
  return (
    <div className="stake-container">
      ...
      {showModal && <UnStakeModal showModal={showModal} setShowModal={setShowModal} /> }
      <header>
        <nav>
