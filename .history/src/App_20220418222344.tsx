...
function App() {
  ...
  const checkIfStaked = () => {
    if (staked){
      return <UnStakeModal staked={staked} setStaked={setStaked} showModal={showModal} setShowModal={setShowModal} />
    }else{
      return <StakeModal staked={staked} setStaked={setStaked} showModal={showModal} setShowModal={setShowModal} />
    }
  }
