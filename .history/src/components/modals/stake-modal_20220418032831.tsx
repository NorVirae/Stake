    ...
    return <div className='stake-modal-container'>
                ...
                <div className='stake-modal'>
                    ...
                    <div className='stake-inner-right'>
                        <ul>
                            <li><span>Start Date</span><span>Start Date</span></li>

                            <li><span>End Date</span><span>Start Date</span></li>

                            <li><span>Period</span></li>

                            <li><span>Minimum Withdrawal Date</span></li>

                            <li><span>Withdrawal Penalty(APR)</span></li>

                            <li><span>Best Deal Reward</span></li>

                            <li><span>Est. All Time Rewards</span></li>
