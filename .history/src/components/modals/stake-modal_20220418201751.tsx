                ...
                <div onClick={e=>null} className='stake-modal'>
                    ...
                    <div className='stake-inner-right'>
                        ...
                        <div className='duration-container'>
                            ...
                            <div onClick={e=>setDuration()} className={`duration-btn ${duration == 0? " duration-btn-active": " " }`}>
                                3 Months
                            </div>

                            <div className={`duration-btn ${duration == 1? " duration-btn-active": " " }`}>
                                6 Months
                            </div>


                            <div className={`duration-btn ${duration == 2? " duration-btn-active": " " }`}>
                                9 Months
                            </div>

                            <div className={`duration-btn ${duration == 3? " duration-btn-active": " " }`}>
                                12 Months
                            </div>
