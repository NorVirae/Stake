...
const StakeModal:React.FC<StakeModalInterface> = ({setShowModal, setStaked, staked, showModal}) => {
    ...
    return <div  className='stake-modal-container'>
                ...
                <div onClick={e=>null} className='stake-modal'>
                    ...
                    <div onClick={e=>{setShowModal(false); console.log("STAKE")}} className='close-btn'>x</div>
                        <h1>FIS Staking </h1>
                        ...
                        <form>
                            <fieldset className='form-group'>
                                ...
                                <input onChange={e=>setAmountToStake(e.target.value)} value={amountToStake} className='form-input'/>
                    ...
                    <div className='stake-inner-right'>
                        ...
                        <div className='type-btn-container'>
                            <div onClick={e => setType('flexible')} className={`btn-type ${type == 'flexible'? ' btn-type-active': " "}`}>
                                    Fixed  
                            </div>

                            <div onClick={e => setType('fixed')} className={`btn-type ${type == 'fixed'? ' btn-type-active': ''}`}>
                                    Flexible  
                            </div>
                        </div>
                        ...
                        <button onClick={e=>setStaked(!staked)} className='stake-button'>Stake</button>
                    </div>
