...
import { StakeModalInterface, UnStakeModalInterface } from '../../@types/interfaces';




const UnStakeModal:React.FC<UnStakeModalInterface> = ({setShowModal, setStaked, staked, showModal}) => {
